        ...
        <div className="mx-auto w-full max-w-7xl space-y-8 px-4 sm:px-6 lg:px-8">
          <div>
            ...
            <ul className="mb-4 list-disc space-y-2 pl-6 md:text-lg">
              ...
              <li>
                ...
                will fit your profile by completing your application
                form/profile.
              </li>
              <li>
            ...
            <p className="mb-4 text-center font-semibold text-gold md:text-lg">
          ...
          <div>
            ...
            <p className="mb-4 md:text-lg">
              ...
              and female members varies. Our friendly team can discuss with you
              in more detail once you have registered your interest.
            </p>
            <h3 className="mb-4 text-center text-gold text-2xl font-semibold">
